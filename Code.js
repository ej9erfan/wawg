...
outputRow++; // Correctly moves to the table header row (only one increment here!)
    ...
    // Apply borders to the table (Header + Client Rows)
  ...
  const diaperSummaryCols = ["Diapers:"]; // match by header start
